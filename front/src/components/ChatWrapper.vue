<template>
	<div class="chat grid grid-cols-12 gap-5">
		<div :class="[ hasConv ? 'hidden md:flex' : 'flex' ]" class="col-span-12 md:col-span-4 list flex-col pr-7">
		...
		<div :class="[ !hasConv ? 'hidden md:flex' : 'flex' ]" class="col-span-12 md:col-span-8 conversation flex-col justify-between px-3 md:px-7 py-5">
			<slot></slot>
		</div>
		<div class="col-span-12 chat" :key="history ">
			<h1>Chat</h1>
